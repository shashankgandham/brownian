...
int n = 10, niter = 21000, file = 0, nbin = 300, maxpart = 100, no_of_colloid = 1, nbox, **nbr, **up_nbr, *cnt, *up_cnt, *fluid_no;
int no_of_fluid = len.prod()*10, *no_neigh, *neigh_fl[10005], *neighbour[256], *n_neighbour, *box_neigh[512], **box_part, **cell_part;
