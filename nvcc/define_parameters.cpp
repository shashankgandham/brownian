...
point mod(point a, point b) {
	a.x = fmod(a.x, b.x)? fmod(fmod(a.x, b.x) + b.x, b.x): b.x;
	a.y = fmod(a.y, b.y)? fmod(fmod(a.y, b.y) + b.y, b.y): b.y;
	a.z = fmod(a.z, b.z)? fmod(fmod(a.z, b.z) + b.z, b.z): b.z;
	return a;
}
point img(point a, point b) {
	return (a - b*point(round(a.x/b.x), round(a.y/b.y), round(a.z/b.z)));
}
