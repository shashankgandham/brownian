subroutine stochastic_reflection
	use all_parameters
	implicit none
	real*8::nx,ny,nz,unx,uny,unz,xx,m_beta,random_e,ux,uy,uz
	real*8::uuu,utx,uty,txx,tyy,tzz,ttt,utz,ran1,val,v1,v2

	m_beta=mass_fl/kbt
!	!! find the normal unit vector from colloid surface(nx,ny,nz)
...
!	!! now find a gaussian tangent vector to this normal, first find the direction of tangent
