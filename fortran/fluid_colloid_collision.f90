...
!         write(730,*) rsx**2+rsy**2+rsz**2
       !!!!!!!!!!!!!!!!1velocity of fluid in streaming step!!!!!!!!!!!!!!!!!!!!1111
           vel_fl(3*lll-2)=u1+vel_colloid(3*j-2)+ang_vel_colloid(3*j-1)*rsz-ang_vel_colloid(3*j)*rsy 
           vel_fl(3*lll-1)=u2+vel_colloid(3*j-1)-ang_vel_colloid(3*j-2)*rsz+ang_vel_colloid(3*j)*rsx   !check
...
!         write(734,*) omega1,omega2,omega3
       !!!!!!!!!!updating position for next dt/2 time !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
